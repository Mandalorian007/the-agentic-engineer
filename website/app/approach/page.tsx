...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "/approach",
    type: "website",
    images: [{ url: "/og", width: 1200, height: 630, alt: APPROACH_TITLE }],
  },
  twitter: {
...
const PRINCIPLES = [
  ...
  },
  {
    ...
    body: "Copilot, Cursor, Claude Code, Codex, Windsurf are tactical. The platform layer is strategic. I build to the meta-layer so the system survives the next tool launch.",
  },
  {
    icon: GaugeCircle,
