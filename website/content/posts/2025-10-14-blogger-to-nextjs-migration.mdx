...
social:
  twitter:
    text: "💥 Migrated my blog from Blogger to Next.js in 4 hours\n\nClaude Code + Perplexity MCP + Firecrawl did research, planning, and implementation\n\nAgentic engineering in action 🚀"
  linkedin:
    text: "I launched a blog on Blogger, then realized it wasn't going to work long-term. Too fragile, too many dependencies, not flexible enough.\n\nSo I did what any agentic engineer would do: I let my AI agents handle the migration.\n\nClaude Code + Perplexity MCP + Firecrawl researched modern blogging platforms, compared frameworks, analyzed hosting options, and drafted a comprehensive migration plan.\n\nThe verdict? Next.js 15 + Vercel + shadcn/ui + Tailwind.\n\nTotal migration time: 4 hours for both the website AND the content pipeline.\n\nThis is the difference between agentic coding (AI writes functions) and agentic engineering (AI researches, plans, architects, and executes complete projects).\n\nI defined the problem space and requirements. My agents did the research, planning, implementation, and validation.\n\nThe result? Simpler workflow (git push vs API calls), faster performance (no external APIs), better DX (hot-reload, TypeScript, local preview), and zero monthly costs.\n\nFull migration story:"
---
...
## From excited to deflated in one afternoon

We did it. The blog was live.

I got stupid giddy the day I first published. The automation was working, the content pipeline was humming, posts were going live. It felt amazing to finally have a public spot for sharing ideas about agentic engineering.
...
But I'm an **agentic engineer**. When you hit a roadblock, you don't bang your head against the wall. You summon your AI agents and let them do the heavy lifting.
...
Then I listed **a whole lot of requirements**:
...
The research even turned up that shadcn/ui has a fantastic ecosystem. I could use the initial shadcn spin-up tool, grab some beautiful prefabs from shadcnblocks, and have something that looks great out of the box.
...
This is where it got interesting. The migration wasn't just about the website. I had an entire **content generation pipeline** to migrate too.
...
This seems a little scary, right? A full migration of both the website AND the automation pipeline?
...
It found its place really quick. The website structure emerged in under an hour. Then we pivoted our Python pipeline right on top of our new beautiful Next.js project.
...
A few of the biggest improvements from this migration:

### 1. Scheduled publishing with ISR

The old system made me manually trigger publishing at the right time. I had cron jobs, publish commands, and status syncing.
...
This is the biggest win. The before and after:
...
I even managed to snag a nice domain through Vercel: **the-agentic-engineer.com**. Super fancy. I'm excited.
...
The big insight from this migration: there's a difference between **agentic coding** and **agentic engineering**.
