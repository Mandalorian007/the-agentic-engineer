...
Bullet journaling changed how I approach productivity. Thinking through your year, breaking it into quarters, structuring weeks with intentional tasks. It's powerful. The daily flow of capturing thoughts, reviewing progress, and adjusting course helped me accomplish things I never thought possible.

But I hit a wall that many bullet journalers recognize: the recovery problem.

## The hidden cost of slipping up

Miss a day or fall off track, and bullet journaling stops being support. It becomes a burden. Suddenly you're facing pages of updates, cross-references to fix, and a mental barrier just to sit down and reorganize everything.
...
That became my litmus test for every decision. Can I use this when I'm running on empty? If not, simplify until I can.

A few hard constraints fell out of this:

- **Minimal active files.** Anything more is overhead you'll abandon.
- **Under 10 minutes daily.** Or it won't happen consistently.
- **Built-in recovery mechanisms.** Falling off is inevitable.
