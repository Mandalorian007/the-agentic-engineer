...
Twelve months ago, we argued about which model was best. Today, we argue about which agent platform fits our workflow. That move from model-centric to agent-centric development defines everything that happened this year.

Here's the timeline.

## Late 2024: the foundation

You can't tell the 2025 story without the groundwork from late 2024. These weren't product launches. They were paradigm shifts wearing release notes.

### September 2024: reasoning arrives

OpenAI's o1-preview dropped on September 12th, and suddenly AI could *think* before answering. Not pattern-match. Not autocomplete. Actually reason through problems step by step.

That mattered for coding. Complex debugging, architecture decisions, and multi-step refactors all require this kind of deliberate thinking. The autocomplete era was ending.

### October 2024: AI gets hands

Claude 3.5 Sonnet's October update came with something wild: computer use beta. For the first time, an AI could see your screen and control your mouse and keyboard. It was clunky. The implications were huge. AI wasn't just suggesting code anymore. It was learning to *operate* computers.

### November 2024: the USB for AI

On November 25th, Anthropic announced MCP, the Model Context Protocol. People called it "the USB for AI agents." That description undersold it.
...
OpenAI made reasoning affordable. The mini model brought step-by-step thinking to everyone, not just enterprise customers. Every developer could now reach a model that actually thought through problems.

### February: the agents land

**February 24th: Claude Code CLI (preview)**

Everything changed here. Anthropic didn't release another chatbot. They released the first true *agentic coding tool*.
...
- Iterate autonomously by exploring, planning, coding, and committing in loops
...
Enterprise-grade reasoning became programmable. Teams could build production systems on top of OpenAI's strongest reasoning capabilities.

**April 16th: OpenAI Codex CLI + o3 general access**

OpenAI entered the agentic CLI war. Codex CLI launched open-source under Apache 2.0, with:
...
Claude Code left preview and went generally available. The bigger story was Claude 4 itself, a model built from the ground up for agentic work.
...
**Copilot** played the integration game, pushing agent mode into JetBrains, Eclipse, and Xcode. If you were already in the Microsoft ecosystem, the path of least resistance was clear.
...
Agent mode reached Xcode and Eclipse. Apple developers and enterprise Java shops got agentic capabilities.

**September 30th: Claude Sonnet 4.5**

The mid-tier model got faster and more reliable. That matters for workflows where cost per token is the constraint.
...
By year's end, the protocol was the standard:
...
Thousands of community-built MCP servers shipped for databases, DevOps tools, productivity apps, and code operations. The N×M integration problem was solved.
...
Every major model release still mattered. Claude 4's extended thinking. o3's reasoning depth. GPT-5's speed and routing. Those capabilities drove real improvements.

But the *interface*, the harness that wrapped these models, became the thing that decided your productivity.
...
Not because the models got smarter, though they did. Not because the tools got faster, though they did. We, the developers, finally figured out how to *work* with these systems effectively.
