...
social:
  ...
  linkedin:
    text: 'The model and the agent harness are two different products. Most people
      ...
      Full writeup:'
---
![Hero image showing interchangeable glowing model cores hovering beside a single machine chassis](../../public/blog/2026-09-21-run-claude-code-any-model-openrouter/hero-swap-model-openrouter.webp)
