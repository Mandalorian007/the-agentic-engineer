...
social:
  twitter:
    text: "🧠 Burnout isn't just from the work—it's from the work ABOUT the work.\n\nI set up an AI agent that auto-scopes every task I create. Analyzes repos, suggests approaches, estimates effort.\n\nNow my backlog feels like a menu, not a burden 👇"
  linkedin:
